...
namespace EvilDesktopPet
{
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            //Not sure where to move this code to 
            /*
            lock (instancesLock)
            {
                instances.Add(this);
            ...
            ****************************************************/
            #region RealImplementation

            /*
            actionTimer.Interval = TimeSpan.FromSeconds(30);
            actionTimer.Tick += DoRandomAction;
            actionTimer.Start();
            */
            #endregion
            ...
            /***************************************************
            * For demoing through all possible actions,
            * Uncomment below
            ****************************************************/
            #region Demo
            /*
            for(int i = 0; i < 10; i++)         // i < #, # must be number of actions
            {
                switch (i)
                {
                    case 0:
        ...
        ******************************************************************************/
        ...
        private void TextToSpeech()
        {
            string[] messages = {
                ...
                $"jfdioajkfljsndkljoiajfioeajsflkdsoiajewokljskfj"
            };
        ...
        /// <summary>
        /// Creates a file called virus.bat on the desktop that when opened opens notepad asking for credit card info
        /// </summary>
        ...
        /// <summary>
        /// Opens and closes a bunch of command windows
        /// </summary>
        ...
        /// <summary>
        /// Opens notepad and displays users ip address
        /// </summary>
        ...
        /// <summary>
        /// Helper method to get ip info
        /// </summary>
        /// <returns>A string representing their local ip address</returns>
        ...
        /// <summary>
        /// Opens a new window asking them to input credit deets, wont let them close until they do
        /// </summary>
        ...
        /// <summary>
        /// Tells the user to change their background
        /// </summary>
        ...
        {
            System.Media.SoundPlayer horror = new System.Media.SoundPlayer();
            string filePath = System.IO.Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Horror.wav");

            horror.SoundLocation = filePath; // Ensure the WAV file is in the executable directory
            horror.Load();
            horror.Play();
        }
